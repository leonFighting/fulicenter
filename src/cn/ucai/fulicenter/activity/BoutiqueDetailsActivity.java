...
public class BoutiqueDetailsActivity extends BaseActivity {
    public static final String TAG = BoutiqueDetailsActivity.class.getName();
    ...
    private void initView() {
        String boutiqueTitleName=getIntent().getStringExtra(D.Boutique.KEY_NAME);
        Log.e(TAG, "boutiqueTitleName=" + boutiqueTitleName);
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.srl_boutiqueDetails);
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.rv_boutiqueDetails);
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setLayoutManager(mGridLayoutManager);
        mAdapter = new GoodAdapter(mContext,mGoodList,I.SORT_BY_ADDTIME_DESC);
        mRecyclerView.setAdapter(mAdapter);
        DisplayUtils.initBackWithTitle(mContext,boutiqueTitleName);
    }
}
